...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.invalidate();
        startMarker.setIcon(getResources().getDrawable(R.drawable.icon2));
        ...
        map.invalidate();
        startMarker2.setIcon(getResources().getDrawable(R.drawable.ico5));
        ...
        map.invalidate();
        startMarker3.setIcon(getResources().getDrawable(R.drawable.ico3));
        ...
        map.invalidate();
        startMarker4.setIcon(getResources().getDrawable(R.drawable.ico4));
        startMarker4.setTitle("Mall Boemi Kedaton");


        GeoPoint startPoint5 = new GeoPoint(-4.825907,104.8876388);
        ...
        map.invalidate();
        startMarker5.setIcon(getResources().getDrawable(R.drawable.ico1));
        startMarker5.setTitle("Rumah Akoh :)");
